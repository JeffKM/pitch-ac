...
function Command({
  ...
  return (
    <CommandPrimitive
      data-slot="command"
      className={cn(
        "flex h-full w-full flex-col overflow-hidden rounded-[var(--comic-panel-radius)] bg-comic-white text-comic-black",
        className,
      )}
      {...props}
    />
...
function CommandInput({
  ...
  return (
    <div
      ...
      className="flex h-9 items-center gap-2 border-comic-black/20 border-b-[var(--comic-border-thin)] px-3"
    >
...
function CommandEmpty({
  ...
  return (
    <CommandPrimitive.Empty
      ...
      className="py-6 text-center font-[family-name:var(--font-permanent-marker)] text-[length:var(--comic-body-base)]"
      {...props}
    />
  );
}
...
function CommandSeparator({
  ...
  return (
    <CommandPrimitive.Separator
      ...
      className={cn(
        "-mx-1 h-0 border-comic-black/20 border-b-[var(--comic-border-thin)]",
        className,
      )}
      {...props}
    />
