...
export async function generateMetadata({
  ...
  const baseMetadata: Metadata = {
    title: "Compare",
    description: "Compare Premier League player stats",
  };
  ...
  const description = `Compare ${player1.name} vs ${player2.name} Premier League season stats`;
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: `${player1.name} vs ${player2.name} comparison card`,
        },
      ],
      type: "website",
    },
